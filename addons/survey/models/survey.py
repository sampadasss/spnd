...
class SurveyPage(models.Model):
    ...
    question_ids = fields.One2many('survey.question', 'page_id', string='Questions', copy=True, ) #domain="[('page_id','like','id')]" 'question_ids.page_id.id' domain="[('page_id','=','question_ids.page_id.id')]"
    ...
    questions_id = fields.Many2many('survey.question','survey_page_question','page_id','question_ids','Questions')
    user_id = fields.Many2one('res.users', string='User', default=lambda self: self.env.user)
...
class SurveyQuestion(models.Model):
    ...
    survey_id = fields.Many2one('survey.survey', related='page_id.survey_id', string='Survey', readonly=True)
    sequence = fields.Integer('Sequence', default=10)
    create_id_survey = fields.Many2one('survey.survey',related='page_id.survey_id', string='Questions')
    # Question
    question = fields.Char('Question Name',required=False, translate=True)
    ...
    type = fields.Selection([
            ...
            ('matrix', 'Matrix')], string='Type of Question', required=False)#default='free_text'
...
class SurveyLabel(models.Model):
    ...
    question_id_2 = fields.Many2one('', string='Question 2', ondelete='cascade')
    sequence = fields.Integer('Label Sequence order', default=10)
    value = fields.Char('Suggested value', translate=True, required=False)
